...
public abstract class AbstractRandomStockQuoteGenerator {
  ...
  AbstractRandomStockQuoteGenerator() {
    instruments = Arrays.asList(
        new RandomStockQuoteGenerator.Instrument("AAPL", STOCK_EXCHANGE_NASDAQ, CURRENCY_US_DOLLAR),
        new RandomStockQuoteGenerator.Instrument("AMZN", STOCK_EXCHANGE_NASDAQ, CURRENCY_US_DOLLAR),
        new RandomStockQuoteGenerator.Instrument("GOOGL", STOCK_EXCHANGE_NASDAQ,
            CURRENCY_US_DOLLAR),
        ...
        new RandomStockQuoteGenerator.Instrument("KO", STOCK_EXCHANGE_NEW_YORK,
            CURRENCY_US_DOLLAR));
  }
  ...
  BigDecimal generateRandomPrice() {
    ...
    BigDecimal randomPrice = BigDecimal.valueOf(
        ThreadLocalRandom.current().nextDouble(leftLimit, rightLimit));
